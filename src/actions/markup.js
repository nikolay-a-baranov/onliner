  ...
  markup: {
    ...
    separatorData: {
      ...
      nearby(value = "", start = 0) {
        return block.marker.nearby(
          value,
          start,
          api.markup.separatorData.match,
        );
      },
    },
    separator(element) {
      ...
      if (!nearby) {
        return api.insert(api.markup.separatorData.marker);
      }
      const result = block.marker.remove(value, nearby);
