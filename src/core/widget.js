...
const template = {
  promo: {
    vote: {
      ...
      text: [
        "<ul>",
        " <li>У каждого пользователя есть два голоса. Вы можете поставить 1\u00A0лайк\u00A0\u{1F44D} и 1\u00A0дизлайк\u00A0\u{1F44E} любому участнику рейтинга.</li>",
        " <li>Ваш голос влияет на позицию участника в общем рейтинге. Чем больше лайков, тем выше участник на странице.</li>",
        " <li>Позиции участников формируются по разнице между лайками и дизлайками.</li>",
        " <li>Вы можете поменять свое мнение и переголосовать в течение всего периода голосования.</li>",
        " <li>Итоговые позиции меняются местами после обновления страницы.</li>",
        " <li>Участники с одинаковым результатом могут занимать одно и то же место.</li>",
        "</ul>",
      ].join("\n"),
      color: "#F5F5F5",
      label: "",
