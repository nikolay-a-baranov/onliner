  ...
  toolbar() {
    return `
        ...
        .panel[data-ui-surface="toolbar"] {
          ...
          --surface-toolbar-logo-scale: 0.9;
          --surface-toolbar-logo-size: calc(var(--surface-toolbar-media-size) * var(--surface-toolbar-logo-scale));
        ...
        .panel[data-ui-surface="toolbar"] .toolbar-logo {
          ...
          transform: translateZ(0) scale(1);
          transition: transform var(--surface-toolbar-icon-motion-duration) var(--surface-toolbar-icon-motion-easing);
        }
        .panel[data-ui-surface="toolbar"] .ui-button:hover .toolbar-logo,
        .panel[data-ui-surface="toolbar"] .ui-button:focus-visible .toolbar-logo {
          transform: translateZ(0) scale(1);
        }
        .panel[data-ui-surface="toolbar"] .ui-button:active .toolbar-logo {
          transform: translateZ(0) scale(1);
        }
        ...
        .panel[data-ui-surface="toolbar"][data-theme="dark"] [data-rail-group] {
          background: var(--surface-toolbar-group-bg-dark);
        ...
        .panel[data-ui-surface="toolbar"] [data-ui-glyph-scale="true"] .toolbar-logo,
        ...
        .panel[data-ui-surface="toolbar"] [data-launchpad-group="true"]:has([data-roadmap-popover="true"]),
        ...
        .panel[data-ui-surface="toolbar"][data-toolbar-flow="rail"][data-dock="floating"] [data-launchpad-group="true"][data-expanded="false"] [data-roadmap-popover="true"] {
          opacity: 0;
          transform: translateY(-50%) translateX(var(--surface-launchpad-motion-offset));
          pointer-events: none;
          visibility: hidden;
        }
        ...
        .panel[data-ui-surface="toolbar"][data-toolbar-flow="rail"]:is([data-dock="top"],[data-dock="bottom"],[data-dock="floating"]):has([data-roadmap-popover="true"][aria-hidden="false"]) {
          overflow: visible;
        }
        ...
        .panel[data-ui-surface="toolbar"][data-toolbar-flow="rail"]:is([data-dock="top"],[data-dock="bottom"],[data-dock="floating"]) .ui-line:has([data-roadmap-popover="true"][aria-hidden="false"]) {
          overflow: visible;
        }
        .panel[data-ui-surface="toolbar"][data-toolbar-flow="rail"]:is([data-dock="top"],[data-dock="bottom"],[data-dock="floating"]) .ui-line:has([data-roadmap-popover="true"][aria-hidden="false"]) > .ui-strip {
          overflow: visible;
        }
...
const skin = {
  ...
  diff: `
    ...
    .panel[data-ui-surface="toolbar"] [data-ui-cluster-row]:has(> [data-ui-cluster-size="fill"]:not([hidden])):not(:has(> :not([hidden]):not([data-ui-cluster-size="fill"]))) {
      grid-template-columns: minmax(0, 1fr) !important;
      justify-content: stretch !important;
    }
    .panel[data-ui-surface="toolbar"] [data-ui-cluster-row]:has(> [data-ui-cluster-size="fill"]:not([hidden])):not(:has(> :not([hidden]):not([data-ui-cluster-size="fill"]))) > [data-ui-cluster-size="fill"]:not([hidden]) {
  ...
  text({ theme, panel, hud }) {
    ...
    return `
        ...
        #${panel}[data-reader-tools="true"]{
          ...
          --reader-tools-grid-gap:var(--surface-icon-box-gap);
          --reader-tools-column-gap:var(--reader-tools-grid-gap);
          --reader-tools-cluster-inset:var(--cluster-inset-x);
          --reader-tools-side-gap:var(--reader-tools-grid-gap);
          --reader-tools-group-column-gap:var(--reader-tools-grid-gap);
          --reader-tools-group-pitch:calc(var(--reader-hud-button-size) + var(--reader-tools-grid-gap));
          ...
          --reader-tools-card-duration:440ms;
          --reader-tools-card-step:330ms;
        ...
        #${panel}[data-reader-tools="true"] .reader-tools-group-slot{
          position:relative!important;
          display:flex!important;
          align-items:center!important;
          justify-content:center!important;
          flex:0 0 var(--reader-hud-button-size)!important;
        ...
        #${panel}[data-reader-tools="true"] .reader-tools-dropdown{
          ...
          align-items:center!important;
          justify-content:center!important;
          flex:0 0 var(--surface-box-size)!important;
          width:var(--surface-box-size)!important;
          min-width:var(--surface-box-size)!important;
          max-width:var(--surface-box-size)!important;
          height:var(--surface-box-size)!important;
          min-height:var(--surface-box-size)!important;
          max-height:var(--surface-box-size)!important;
          overflow:visible!important;
          isolation:isolate!important
        }
        #${panel}[data-reader-tools="true"] .reader-tools-dropdown > [data-launchpad-group-head="true"]{
          display:flex!important;
          align-items:center!important;
          justify-content:center!important;
          flex:0 0 var(--surface-box-size)!important;
        ...
        #${panel}[data-reader-tools="true"] .reader-tools-dropdown > [data-launchpad-group-head="true"] > [data-action="group"]{
          position:relative!important;
          z-index:2!important;
          flex:0 0 var(--surface-box-size)!important;
          width:var(--surface-box-size)!important;
        ...
        #${panel}[data-reader-tools="true"] .reader-tools-cluster[data-ui-marker="true"]:has(.reader-tools-dropdown[data-expanded="true"]){
          background:transparent!important;
        ...
        #${panel}[data-reader-tools="true"] [data-reader-tools-preview="false"] .reader-tools-command-slot,
        #${panel}[data-reader-tools="true"] [data-reader-tools-preview="false"] .reader-tools-command-slot *,
        #${panel}[data-reader-tools="true"] [data-reader-tools-preview="false"] .reader-tools-command-slot::before,
        #${panel}[data-reader-tools="true"] [data-reader-tools-preview="false"] .reader-tools-command-slot::after{
          opacity:1!important
        }
        #${panel}[data-reader-tools="true"] [data-reader-tools-preview="true"] .reader-tools-command-slot{
          opacity:var(--reader-card-opacity)
        }
        #${panel}[data-reader-tools="true"] [data-reader-tools-preview="true"] .reader-tools-command-slot .reader-tools-command{
          opacity:1!important
        }
        ...
        #${panel}[data-reader-tools="true"] [data-action="group"][data-reader-tools-icon-motion="opening"] > .launchpad-scenario-icon{
          animation:readerToolsIconOpen 560ms cubic-bezier(.2,.7,.2,1) both!important
        }
        ...
        #${panel}[data-reader-tools="true"] [data-action="group"][data-reader-tools-icon-motion="closing"] > .launchpad-scenario-icon{
          animation:readerToolsIconClose 560ms cubic-bezier(.2,.7,.2,1) both!important
        }
        ...
        #${panel}[data-reader-tools="true"] .reader-tools-command.reader-hud-button{
          ...
          color:var(--reader-action-button-text)!important;
          opacity:var(--reader-card-opacity)!important;
  ...
  media: {
    ...
    thumb(id = "media-thumb-flow-control") {
      return `
        ...
        #${id} [data-thumb-mode-actions="true"]{display:none!important;}
        #${id}[data-thumb-crop-mode="text"] [data-thumb-text-actions="true"],
        #${id}[data-thumb-crop-mode="neuroslop"] [data-thumb-neuroslop-actions="true"]{
        ...
        #${id} [data-thumb-action-slot="left-control"]{grid-column:1;grid-row:1;}
        #${id} [data-thumb-action-slot="left-top"]{grid-column:1;grid-row:2;}
        #${id} [data-thumb-action-slot="left-bottom"]{grid-column:1;grid-row:3;}
        #${id} [data-thumb-action-slot="right-control"]{grid-column:2;grid-row:1;}
        #${id} [data-thumb-action-slot="right-top"]{grid-column:2;grid-row:2;}
        #${id} [data-thumb-action-slot="right-bottom"]{grid-column:2;grid-row:3;}
        @media (min-width:701px){
          #${id}[data-thumb-crop-mode="text"] [data-thumb-text-actions="true"]{
            grid-template-columns:max-content!important;
            justify-content:center!important;
          }
          #${id}[data-thumb-crop-mode="text"] [data-thumb-action-slot]{
            grid-column:1!important;
            justify-self:center!important;
          }
          #${id}[data-thumb-crop-mode="text"] [data-thumb-action-slot="left-control"]{grid-row:1!important;}
          #${id}[data-thumb-crop-mode="text"] [data-thumb-action-slot="left-top"]{grid-row:2!important;}
          #${id}[data-thumb-crop-mode="text"] [data-thumb-action-slot="left-bottom"]{grid-row:3!important;}
        }
        #${id}[data-thumb-crop-mode="text"] [data-thumb-text-placement="true"]{
          display:inline-flex!important;
          justify-self:center!important;
        ...
        #${id}[data-thumb-crop-mode="text"] [data-thumb-text-placement="true"] > .ui-group-body{
          display:inline-flex!important;
          align-items:center!important;
          justify-content:center!important;
          width:auto!important;
        ...
        #${id}[data-thumb-crop-mode="text"] [data-thumb-text-placement="true"] [data-action="text.placement"]{
          padding:0!important;
        }
        @media (max-width:700px){
        ...
        #${id} [data-thumb-actions="mode"] .media-thumb-flow-crop-mode-hit{
          position:absolute!important;
          z-index:2!important;
          inset:0!important;
          width:100%!important;
        ...
        #${id} [data-thumb-actions="mode"] .media-thumb-flow-crop-text{
          ...
          height:var(--surface-button-size)!important;
          min-height:var(--surface-button-size)!important;
          max-height:var(--surface-button-size)!important;
        }
        #${id} [data-thumb-actions="mode"] .media-thumb-flow-crop-text{
          position:relative!important;
          z-index:1!important;
          ...
          line-height:1!important;
          text-align:center!important;
          font-size:calc(var(--control-font-size) * var(--thumb-mode-label-scale))!important;
          font-weight:400!important;
          opacity:1!important;
          pointer-events:none!important;
          transition:font-size var(--surface-toolbar-icon-motion-duration) var(--surface-toolbar-icon-motion-easing)!important;
        }
        #${id} [data-thumb-actions="mode"] .media-thumb-flow-crop-mode-hit:hover + .media-thumb-flow-crop-text,
        #${id} [data-thumb-actions="mode"] .media-thumb-flow-crop-mode-hit:focus-visible + .media-thumb-flow-crop-text{
          font-size:calc(var(--control-font-size) * var(--thumb-mode-label-scale) * var(--surface-toolbar-text-hover-scale))!important;
        }
        #${id}[data-theme="dark"] [data-thumb-actions="mode"] .media-thumb-flow-crop-text{
          color:var(--surface-toolbar-capsule-text-dark)!important;
        }
        #${id}[data-theme="light"] [data-thumb-actions="mode"] .media-thumb-flow-crop-text{
          color:var(--surface-toolbar-capsule-text-light)!important;
        }
        ...
        #${id} [data-thumb-crop-status="true"][data-thumb-status-center="true"]{
          align-items:center!important;
          justify-content:center!important;
